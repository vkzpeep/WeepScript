...
local RandomShitTalk = {
    ...
    ["Main"] = {
        ...
        "#Neurasthenia Lock better XD .gg/dhmscript",
        "Neurasthenia Lock user VV 😳😳😳",
        "just a skill issue that you dont have Neurasthenia Lock",
        "mad cause no Neurasthenia Lock LOL .gg/dhmscript"
    }
}
...
local Window = Library:CreateWindow("Neurasthenia Lock", Vector2.new(492, 598), Enum.KeyCode.RightShift)
